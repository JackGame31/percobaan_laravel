...
<div class="container">
    <div class="row my-3">
        <div class="col-lg-8">
            ...
            {{-- Edit --}}
            <a href="/dashboard/posts/{{ $post->slug }}/edit" class="btn btn-warning"><i class="bi bi-pen-fill fs-5 me-2"></i> Edit</a>
            ...
            <form action="/dashboard/posts/{{ $post->slug }}" method="post" class="d-inline">
                ...
                <button class="btn btn-danger" onclick="return confirm('Are you sure?')"><i class="bi bi-x-circle fs-6"></i> Delete</button>
            </form>
